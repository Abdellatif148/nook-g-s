      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-5 py-4 flex items-center justify-between bg-bg/80 backdrop-blur-md border-b border-border/50">
        <div className="flex items-center gap-2">
          <img
            ...
            alt="Nook OS"
            className={`w-7 h-7 drop-shadow-sm ${logo ? "object-contain bg-white/10 rounded-lg p-0.5" : ""}`}
          />
        ...
        <div className="flex items-center">
          ...
          >
            <span className={language === "fr" ? "text-accent" : "text-text3"}>
              FR
            </span>
            <span className="text-text3 mx-1.5 font-medium">/</span>
            <span className={language === "en" ? "text-accent" : "text-text3"}>
              EN
            </span>
          </button>
        </div>
      ...
      <main className="pt-24 pb-20 px-5 max-w-md mx-auto relative z-10">
        ...
        >
          {[
            ...
            <div
              key={i}
              className="flex items-center justify-center gap-2 text-sm font-medium text-text2"
            >
