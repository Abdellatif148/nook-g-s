    ...
    Tables: {
      ...
      sessions: {
        Row: {
          ...
          extras_total: number
          total_amount: number
          payment_method: 'cash' | 'card' | 'account' | 'free' | null
      ...
      session_consumptions: {
        ...
        Insert: Partial<Database['public']['Tables']['session_consumptions']['Row']>
        Update: Partial<Database['public']['Tables']['session_consumptions']['Row']>
      }
      client_accounts: {
        Row: {
          id: string
      ...
      balance_transactions: {
        Row: {
          ...
          billing_mode: 'time' | 'consumption' | null
          breakdown: Json
          created_at: string
        }
        Insert: Partial<Database['public']['Tables']['balance_transactions']['Row']>
        Update: Partial<Database['public']['Tables']['balance_transactions']['Row']>
      }
      audit_log: {
        Row: {
          id: string
